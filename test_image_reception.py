#!/usr/bin/env python3
"""
Script para probar la recepción de imágenes del ESP32
"""
...
def test_image_reception():
    """Probar la recepción de imágenes"""
    
    # Configuración del servidor
    HOST = '0.0.0.0'
    PORT = 8080
    
    print("🧪 Probando recepción de imágenes del ESP32")
    print("=" * 50)
